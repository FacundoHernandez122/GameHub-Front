            ...
            <div className="row mb-5 mt-2">
              ...
              <div className="col-md-12">
                ...
                <p>
                  ...
                  that mesmerizes millions. Our goal? Whip up a platform that
                  worships gaming culture while delivering top-notch goods and
                  services.
                </p>
              </div>
              <div className="col-md-12">
                ...
                <p>
                  ...
                  a chance to flex our creative muscles. We thrived on the
                  challenge and relished the adventure.
                </p>
              </div>
              <div className="col-md-12">
              ...
              <div className="col-md-12">
                ...
                <p>
                  Despite the tight timeline, our journey was not devoid of fun
                  and camaraderie. We shared laughs, brainstormed ideas, and
                  celebrated small victories together. Each line of code and
                  pixel on the screen was a testament to our passion for
                  technology and the world of gaming.
                </p>
              </div>
              <div className="col-md-12">
                <h4 className="sub_title">A Window to the Future</h4>
                <p>
                  To sum it up, our journey through e-commerce was a whirlwind
                  of challenges, victories, and unforgettable moments. We invite
                  you to hop aboard this thrilling adventure as we navigate the
                  ever-evolving landscape of the video game industry,
                  <strong style={{ color: "#fca311" }}>
                    {" "}
                    ONE PIXEL AT A TIME.
                  </strong>
        ...
        <div className="row pb-5 d-flex justify-content-center">
                ...
                <ul className="profile-links">
                  <div className="border_links_agustin">
                    <li className="list_color">
                      <Link className="description_aboutUs_agustin list_color">
                        LinkedIn
                      </Link>
                    </li>
                  </div>
                  <div className="border_links_rodrigo">
                    <li className="list_color">
                      <Link className="list_color description_aboutUs_agustin">
                        Github
                      </Link>
                    </li>
                  </div>
          ...
          <div className="col-lg-2 col-md-4 col-sm-6 mb-4">
            <div className="background_paula background me-2">
              <img
                className="img_aboutUs mt-3"
                src="/img/WomanAvatar.avif"
                alt=""
              />
              <div className="aboutUs_content_paula">
                <h3 className="text-center mt-3 description_aboutUs_paula ">
                  Paula Serna
                </h3>
                <p className="text-center description_aboutUs_paula">
                  Full Stack Developer
                </p>
              </div>
              <div className=" text-center m-3 ">
                <ul className="profile-links">
                  <div className="border_links_paula">
                    <li className="list_color">
                      <Link className="description_aboutUs_paula list_color">
                        LinkedIn
                      </Link>
                    </li>
                  </div>
                  <div className="border_links_rodrigo">
                    <li className="list_color">
                      <Link className="list_color description_aboutUs_paula">
                        Github
                      </Link>
                    </li>
                  </div>
                ...
                <ul className="profile-links">
                  <div className="border_links_facundo">
                    <li className="list_color">
                      <Link
                        to={
                          "https://www.linkedin.com/in/facundohernandezcasas/"
                        }
